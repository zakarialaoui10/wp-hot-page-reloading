...
const matser = (0,ziko_src_hooks_use_ipc_js__WEBPACK_IMPORTED_MODULE_0__.useIPC)(_shared_js__WEBPACK_IMPORTED_MODULE_1__.CHANNEL_NAME);
(() => {
  let wasSaving = false;
  wp.data.subscribe(() => {
    ...
    if (wasSaving && !isSaving) {
      matser.emit(_shared_js__WEBPACK_IMPORTED_MODULE_1__.EVENT_NAME);
